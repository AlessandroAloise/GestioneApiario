...
public class AddRegina extends javax.swing.JDialog {
    ...
    private void raiseChange() {
        PropertyChangeEvent event = new PropertyChangeEvent(this, "regina", false,datePicker1.getDate());
    ...
    private void initComponents() {
        ...
        data.setText("Data:");
        getContentPane().add(data, java.awt.BorderLayout.LINE_START);
        getContentPane().add(datePicker1, java.awt.BorderLayout.CENTER);
